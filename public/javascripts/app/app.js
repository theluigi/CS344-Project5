...
var main = function () {
    "use strict";
    var totalCategories = " ", taskCounter = 0, setUpClickHandler = function (anchor) {
    ...
    var categorizedTab = function () {
        ...
        var categories = totalCategories.split(" "), uniqueCategories = [];
        ...
        for (y=0; y<taskCounter; y++) {
            ...
            taskCats = $("#task" + taskCounter + " .cats").html(),
            splitCats = taskCats.split(" "),
            z;
